                ...
                <section className='container'>
                    <div className="row">
                        <div className="col-md-3">
                            <h3 className="mt-5 mb-3">Music-Land</h3>
                            <small>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur quae ipsum laborum, obcaecati dolore illum nemo iste repellendus ut nihil?</small>
                        ...
                        <div className="col-md-4">
                            ...
                            <p>
                                ...
                                <small className="mx-2">221B Bekar Rasta, Noakhali, Bangladesh</small>
                            </p>
                            <p>
                                <i class="fas fa-phone-alt ml-icons-contact"></i>
                                <small className="mx-2">0173829834984</small>
                            </p>
                            <p>
                                <i class="fas fa-envelope ml-icons-contact"></i>
                                <small className="mx-2">admin@gmail.com</small>
                            </p>

                        </div>
                        <div className="col-md-5">
                            <h3 className="mt-5 mb-3">Instagram</h3>
                            <small>Instagram did not return a 200.</small>
                        </div>
                    </div>
